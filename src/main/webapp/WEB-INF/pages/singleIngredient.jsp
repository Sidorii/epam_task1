...
<div class="container">
    ...
    <fmt:bundle basename="MessageBundle" prefix="ingredient.">
        <div class="jumbotron">
           ...
           <fmt:message key="weight"/>: <b>${requestScope.ingredient.weight}</b>
            <fmt:message key="calories"/>: <b>${requestScope.ingredient.calories}</b>
            <fmt:message key="price"/>:<b> ${requestScope.ingredient.price}</b>
            <fmt:message key="fresh"/>: <b>${requestScope.ingredient.fresh}</b>
            <fmt:message key="type"/>: <b>${requestScope.ingredient.type.name().toLowerCase()}</b>
